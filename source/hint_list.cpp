...
--------------------------*/
    ...
    hintTable[HEROS_SHIELD] = HintText::Item({
        /*obscure*/Text{"a basic shield", "un bouclier basique", "un blasón básico"}},
    ...
    hintTable[LENS_OF_TRUTH] = HintText::Item({
        /*obscure*/Text{"a lie detector", "un perce-mensonge", "un detector de mentiras"}},
...
//PROGRESSIVE ITEMS (unused currently)
    ...
    hintTable[PROGRESSIVE_MAGIC_METER] = HintText::Item({
        /*obscure*/Text{"progressive magic meter", "de l'endurance sorcière", "poder mágico progresivo"}},
...
//BOTTLE ITEMS
    ...
    hintTable[BOTTLE_WITH_SPRING_WATER] = HintText::Item({
        /*obscure*/Text{"a fresh drink", "un petit arrosage", "un líquido fresco"}},
...
//SONGS
    ...
    hintTable[SONG_OF_HEALING] = HintText::Item({
        /*obscure*/Text{"a soothing melody", "le repos des âmes", "una canción calmante"}},
    ...
    //    /*obscure*/Text{"double time", "une réduction des attentes", "tiempo acelerado"}},
    ...
    hintTable[NEW_WAVE_BOSSA_NOVA] = HintText::Item({
        /*obscure*/Text{"a song of newborns", "un chant de nourrissons", "canción para nacimientos"}},
...
// Clock Tower
    ...
    hintTable[CLOCK_TOWER_SONG_OF_TIME] = HintText::Sometimes({Text{"a timeless song", "le #souvenir de la princesse# est", ""}});
...
//East Clock Town
    ...
    hintTable[E_CLOCK_TOWN_GORMAN] = HintText::Sometimes({
        ...
        /* clear */Text{"Gorman's reward at the Milk Bar is", "la #récompense de Gorman au bar laitier# est","la recompensa de Gorman en el Bar Lácteo es"});
...
//Goron Village
    ...
    hintTable[GORON_VILLAGE_SCRUB_TRADE] = HintText::Sometimes({
        ...
        /* clear */Text{"Business Scrubs trade for the Swamp Title Deed", "une peste marchande #échange un titre de marais# contre","el Mercader Deku intercambia la propiedad del Pantano por"});
...
//Great Bay Coast
    hintTable[GBC_OCEAN_SPIDER_DAY1] = HintText::Sometimes({
        /*obscure*/Text{"a new ocean home owner rewards", "un #emménagement côtier# octroie", "un nuevo dueño de una casa en el océano recompensa con"}},
    ...
    hintTable[GBC_OCEAN_SPIDER_CHEST] = HintText::Sometimes({
        /*obscure*/Text{"the colored masks contains", "les #masques colorés# protègent", "las máscaras de colores contienen"}},
    ...
    hintTable[GBC_LAB_FISH] = HintText::Sometimes({
        ...
        /* clear */Text{"the Marine Research Lab's fish have", "les #poissons du labo de recherche océanique# ont","los peces en el Laboratorio de Investigación Marina tienen"});
...
//Ikana Canyon
    ...
    hintTable[IKANA_CANYON_SCRUB_TRADE] = HintText::Sometimes({
        ...
        /* clear */Text{"Business Scrubs trade for the Ocean Title Deed", "une peste marchande #échange un titre d'océan# contre","el Mercader Deku intercambia la propiedad del Océano por"});
...
//Ikana Graveyard
    hintTable[IKANA_GRAVEYARD_DAMPE_DIGGING] = HintText::Sometimes({
        /*obscure*/Text{"a fearful basement contains", "#déterrer trois flammes# révèle", "un sótano aterrorizante contiene"}},
    ...
    hintTable[IKANA_GRAVEYARD_DAY_ONE_GRAVE_TABLET] = HintText::Sometimes({
        /*obscure*/Text{"a hollow ground teaches", "#la requête du compositeur# octroie", "un suelo hueco enseña"}},
    ...
    hintTable[IKANA_GRAVEYARD_GROTTO_CHEST] = HintText::Sometimes({
        ...
        /* clear */Text{"the Ikana Graveyard grotto contains", "le #trou secret du cimetière d'Ikana# contient","la gruta en el cementerio de Ikana contiene"});
//Laundry Pool
    hintTable[LAUNDRY_POOL_KAFEI] = HintText::Sometimes({
        /*obscure*/Text{"a posted letter rewards", "#rencontrer un disparu# octroie", "una carta enviada recompensa con"}},
    ...
    hintTable[LAUNDRY_POOL_GURU_GURU] = HintText::Sometimes({
        /*obscure*/Text{"a musician gives", "un #musicien ambulant# délègue", "un músico da"}},
...
//Mountain Village
    ...
    hintTable[MOUNTAIN_WATERFALL_CHEST] = HintText::Sometimes({
        /*obscure*/Text{"a springtime waterfall contains", "une #chute d'eau printanière# contient", "una cascada en primavera contiene"}},
    ...
    hintTable[MOUNTAIN_VILLAGE_SPRING_WATER_GROTTO_CHEST] = HintText::Sometimes({
        /*obscure*/Text{"a springtime cave contains", "une #grotte printanière# contient", "una cueva en primavera contiene"}},
...
//N Clock Town
    hintTable[N_CLOCK_TOWN_GREAT_FAIRY_DEKU] = HintText::Sometimes({
        ...
        /* clear */Text{"the Clock Town Great Fairy grants to a Deku", "#montrer le masque mojo à la grande fée de Bourg-Clocher# octroie","la hada de la magia recompensa con"});
    ...
    hintTable[N_CLOCK_TOWN_OLD_LADY] = HintText::Sometimes({
        /*obscure*/Text{"an old lady's struggle rewards", "#aider une aînée# octroie", "el forcejeo de una anciana recompensa con"}},
    ...
    hintTable[N_CLOCK_TOWN_GREAT_FAIRY_HUMAN] = HintText::Sometimes({
        /*obscure*/Text{"the fairy of magic rewards", "la #fée des enchantements# prodigue", "la hada de la magia recompensa con"}},
        /* clear */Text{"the Clock Town Great Fairy grants to a Hylian", "la #grande fée de Bourg-Clocher# donne à quiconque","la gran hada en la Ciudad le otorga a un Hyliano"});
...
//Road to Snowhead
    ...
    hintTable[ROAD_TO_SNOWHEAD_GROTTO_CHEST] = HintText::Sometimes({
        ...
        /* clear */Text{"the grotto near Snowhead contains", "le #trou près du pic des Neiges# contient","la gruta cerca del Pico Nevado contiene"});
//Pinnacle Rock
...
//S Clock Town
    hintTable[S_CLOCK_TOWN_SCRUB_TRADE] = HintText::Sometimes({
        ...
        /* clear */Text{"Business Scrubs trade for the Moon's Tear", "une peste marchande #échange une larme de lune# contre","el Mercader Deku intercambia la Lágrima de la luna por"});
    ...
    hintTable[S_CLOCK_TOWN_BANK_REWARD_2] = HintText::Sometimes({
        /*obscure*/Text{"interest rewards", "#accumuler quatre chiffres# confère", "una comisión recompensa con"}},
...
//Southern Swamp
    hintTable[SOUTHERN_SWAMP_MUSIC_STATUE] = HintText::Sometimes({Text{"a guiding owl teaches", "un #sage hibou# enseigne", ""}});
    hintTable[SOUTHERN_SWAMP_KOUME] = HintText::Sometimes({
        ...
        /* clear */Text{"Koume's reward is a cruise and", "Koume #offre à son sauveur# une croisière et","la recompensa de Koume es un viaje en bote y"});
    ...
    hintTable[SOUTHERN_SWAMP_SCRUB_TRADE] = HintText::Sometimes({
        ...
        /* clear */Text{"Business Scrubs trade for the Town Title Deed", "une peste marchande #échange un titre de terre# contre","el Mercader Deku intercambia la propiedad de la Ciudad por"});
    ...
    hintTable[SOUTHERN_SWAMP_BOAT_ARCHERY] = HintText::Sometimes({
        /*obscure*/Text{"a swamp game rewards", "#frôler un balai habilement# octroie", "un juego del pantano recompensa con"}},
    ...
    hintTable[SOUTHERN_SWAMP_SCRUB_TRADE_CLEAR] = HintText::Sometimes({
        ...
        /* clear */Text{"Business Scrubs trade for the Town Title Deed", "une peste marchande #échange un titre de terre# contre","el Mercadee Deku intercambia la propiedad de la Ciudad por"});
...
//W Clock Town
    ...
    hintTable[W_CLOCK_TOWN_ALL_NIGHT_MASK_BUY] = HintText::Sometimes({
        /*obscure*/Text{"a shady town merchant sells", "un #commerce suspect# vend", "un mercader sospechoso en la ciudad vende"}},
    ...
    hintTable[W_CLOCK_TOWN_CURIOSITY_BOMB_BAG] = HintText::Sometimes({
        /*obscure*/Text{"a shady town merchant sells", "un #commerce suspect# peut recevoir", ""}},
        /* clear */Text{"**ENGLISH**", "la #marchandise volée atterrie au bazar# est",""});
    ...
    hintTable[TRADING_POST_ITEM_1] = HintText::Sometimes({
        ...
        /* clear */Text{"the Trading Post sells", "#Troc en Trop# vend","el Lugar de Intercambio vende"});
...
//Zora Cape
    ...
    hintTable[ZORA_CAPE_BEAVER_RACE_1] = HintText::Sometimes({
        /*obscure*/Text{"a river dweller rewards", "de #gros rongeurs mouillés# détiennent", "un morador del río recompensa con"}},
...
//Zora Hall
    hintTable[ZORA_HALL_SCRUB_TRADE] = HintText::Sometimes({
        ...
        /* clear */Text{"Business Scrubs trade for the Mountain Title Deed", "une peste marchande #échange un titre de montagne# contre","el Mercader Deku intercambia la propiedad de la montaña por"});
    hintTable[ZORA_HALL_EVAN] = HintText::Sometimes({
        /*obscure*/Text{"a musician rewards", "#se faire voler une chanson# octroie", "un músico recompensa con"}},
    ...
    //    /* clear */Text{"the Lulu fan's reward for a good picture is", "le #mégafan de Lulu échange une bonne photo# contre","la recompensa del fan de Lulú por una buena luminografía es"});
...
-------------------------*/
    ...
    hintTable[WF_SF_ENTRANCE_FAIRY] = HintText::Exclude({
        ...
        /* clear */Text{"the item hovering near the Woodfall Temple entrance is", "l'#objet volant près de l'entrée du temple de Bois-Cascade# est","el objeto flotando cerca de la entrada del Templo del Bosque Catarata es"});
    ...
    hintTable[ODOLWA_HEART_CONTAINER] = HintText::Exclude({
        /*obscure*/Text{"a masked evil contains", "occire le #guerrier de la jungle# octroie", "un mal enmascarado contiene"}},
        /* clear */Text{"Odolwa has", "#Odolwa# a","Odolwa tiene"});
    hintTable[GIANTS_OATH_TO_ORDER] = HintText::Exclude({Text{"a gentile giant teaches", "un #gentil géant# enseigne", ""}});
//Snowhead Temple
    ...
    hintTable[SH_SF_DINOLFOS_1] = HintText::Exclude({
        /*obscure*/Text{"a lost fairy is", "une #fée verte# est", "una hada perdida es"}},
        /* clear */Text{"a Snowhead Temple Dinolfos protects", "un #dinolfos du temple du pic des Neiges# contient","un Dinolfos en el Templo del Pico Nevado resguarda"});
    ...
    hintTable[SH_SF_MAP_ROOM_FAIRY] = HintText::Exclude({
        /*obscure*/Text{"a lost fairy is", "une #fée verte# est", "una hada perdida es"}},
        /* clear */Text{"the item hovering near the Snowhead Temple elevator is", "l'#objet volant près de l'ascenseur du temple du pic des Neiges# est","el objeto flotando cerca del elevador en el Templo del Pico Nevado es"});
...
//Great bay Temple
    hintTable[GBT_ICE_ARROW_CHEST] = HintText::Exclude({
        /*obscure*/Text{"the murky watered temple contains", "le #temple en eaux troubles# contient", "el templo de aguas turbias contiene"}},
    ...
    hintTable[GBT_SF_SKULLTULA] = HintText::Exclude({
        /*obscure*/Text{"a lost fairy is", "une #fée violette# est", "una hada perdida es"}},
    ...
    hintTable[GYORG_HEART_CONTAINER] = HintText::Exclude({
        /*obscure*/Text{"a masked evil contains", "abattre un #énorme poisson# octroie", "un mal enmascarado contiene"}},
...
//Secret Shrine
    ...
    hintTable[SECRET_SHRINE_WIZZROBE_CHEST] = HintText::Exclude({
        /*obscure*/Text{"a secret place contains", "#huit cœurs# débloquent", "un lugar secreto contiene"}},
    ...
    hintTable[SECRET_SHRINE_GARO_CHEST] = HintText::Exclude({
        /*obscure*/Text{"a secret place contains", "#seize cœurs# débloquent", "un lugar secreto contiene"}},
...
//Southern Swamp Skulltula House
    ...
    hintTable[SSH_MONUMENT_ROOM_LOWER_WALL] = HintText::Exclude({
        /*obscure*/Text{"a gold spider is", "une #âme d'or marécageuse# est", "una araña dorada es"}},
        /* clear */Text{"the swamp Skulltula high on the slab room wall has", "la #skulltula des marais sur le mur de la pièce à stèle# a","la Skulltula del pantano andando sobre la pared del cuarto del monumento tiene"});
